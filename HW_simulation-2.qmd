...
# # Small run just to verify everything works (NOT the final run)
# tmp <- one_rep(n = 10, beta_treat = 0.5, err = "normal",
#                B = 50, B_inner = 20, alpha = 0.05)
# 
# tmp

# run one scenario and save to disk (demo size)
out_file <- run_one_scenario(
  n = 50,
  beta_treat = 0.5,
  err = "t3",
  nSim = 1,       # demo; use 500 in final
  B = 500,
  B_inner = 100,
  alpha = 0.05,
  out_dir = "data",
...
```{r fig-bias, fig.cap="Bias of the treatment effect estimator $\hat{\\beta}_{treatment}$ across simulation scenarios. The dashed line indicates zero bias."}
### bias of hat beta
